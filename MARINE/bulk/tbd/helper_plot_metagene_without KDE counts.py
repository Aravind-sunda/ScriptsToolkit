...
Use --histogram for binned bars and --counts for raw counts.
...
def main():
    ...
    ap.add_argument("--counts", action="store_true",
                    help="With --histogram, plot raw counts instead of density "
                         "(not recommended for comparing libraries).")
    ...
    ylabel = "Site count" if (args.histogram and args.counts) else "Density"
    fw = fh = None
    if args.figsize:
