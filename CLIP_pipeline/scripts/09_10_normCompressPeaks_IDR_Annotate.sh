...
usage() {
    echo "Usage: $0 \\"
    echo "  --rep1-input-bam <path> \\"
    echo "  --rep2-input-bam <path> \\"
    echo "  --rep1-clip-bam  <path> \\"
    echo "  --rep2-clip-bam  <path> \\"
    echo "  --rep1-peaks-bed <path> \\"
    echo "  --rep2-peaks-bed <path> \\"
    echo "  --homedir        <path>"
    exit 1
}
...
while [[ $# -gt 0 ]]; do
    case "$1" in
        --rep1-input-bam)  rep1_input_bam="$2";  shift 2 ;;
        --rep2-input-bam)  rep2_input_bam="$2";  shift 2 ;;
        --rep1-clip-bam)   rep1_clip_bam="$2";   shift 2 ;;
        --rep2-clip-bam)   rep2_clip_bam="$2";   shift 2 ;;
        --rep1-peaks-bed)  rep1_peaks_bed="$2";  shift 2 ;;
        --rep2-peaks-bed)  rep2_peaks_bed="$2";  shift 2 ;;
...
missing=()
[[ -z "$rep1_input_bam" ]] && missing+=("--rep1-input-bam")
[[ -z "$rep2_input_bam" ]] && missing+=("--rep2-input-bam")
[[ -z "$rep1_clip_bam"  ]] && missing+=("--rep1-clip-bam")
[[ -z "$rep2_clip_bam"  ]] && missing+=("--rep2-clip-bam")
[[ -z "$rep1_peaks_bed" ]] && missing+=("--rep1-peaks-bed")
[[ -z "$rep2_peaks_bed" ]] && missing+=("--rep2-peaks-bed")
[[ -z "$HOMEDIR"        ]] && missing+=("--homedir")
...
echo "  rep1_input_bam: $rep1_input_bam"
echo "  rep2_input_bam: $rep2_input_bam"
echo "  rep1_clip_bam:  $rep1_clip_bam"
echo "  rep2_clip_bam:  $rep2_clip_bam"
echo "  rep1_peaks_bed: $rep1_peaks_bed"
echo "  rep2_peaks_bed: $rep2_peaks_bed"
